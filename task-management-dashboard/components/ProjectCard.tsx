...
export default function ProjectCard({ projectName = "Project-1" }: { projectName?: string }) {
  return (
    <div className="bg-[var(--card)] rounded-lg shadow p-4 sm:p-6 flex flex-col md:flex-row md:items-center gap-2 md:gap-6 cursor-pointer">
      ...
      <div className="flex items-center gap-2 mt-2 md:mt-0">
        ...
        <Button variant="outline" className="ml-2 px-3 py-1 text-xs w-full md:w-auto">Manage</Button>
      </div>
