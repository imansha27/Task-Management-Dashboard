...
export default function Sidebar({ open = true }: { open?: boolean }) {
  return (
    <aside
      className={`fixed top-0 left-0 h-screen z-30 shadow border-r bg-white flex flex-col justify-between transition-all duration-300 ${open ? 'w-64' : 'w-0 overflow-hidden'}`}
