...
import DetailsCardDialog from "@/components/DetailsCardDialog";
...
export default function TaskCard({ title, priority, dueDate, reports, image, category = 'Presentation', categoryColor = 'bg-orange-400', description }: {
  title: string;
  priority: string;
  dueDate?: string;
  reports?: number;
  ...
  return (
    <>
      <div
        className="w-full max-w-xs rounded-xl border border-[var(--border)] shadow-sm bg-[var(--muted)] cursor-pointer hover:shadow-md transition duration-150"
